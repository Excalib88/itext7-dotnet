...
namespace iText.Html2pdf.Attach.Impl.Layout {
    ...
    public class HtmlDocumentRenderer : DocumentRenderer {
        ...
        */
        public override void ShrinkCurrentAreaAndProcessRenderer(IRenderer renderer, IList<IRenderer> resultRenderers
            , LayoutResult result) {
            if (renderer != null) {
        ...
        */
        public override PageSize AddNewPage(PageSize customPageSize) {
            PdfPage addedPage;
