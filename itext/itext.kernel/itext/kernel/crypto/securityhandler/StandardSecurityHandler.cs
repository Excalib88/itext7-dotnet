...
namespace iText.Kernel.Crypto.Securityhandler {
    public abstract class StandardSecurityHandler : SecurityHandler {
        public const int PERMS_MASK_1_FOR_REVISION_2 = unchecked((int)(0xffffffc0));

        public const int PERMS_MASK_1_FOR_REVISION_3_OR_GREATER = unchecked((int)(0xfffff0c0));

        public const int PERMS_MASK_2 = unchecked((int)(0xfffffffc));

        public long permissions;

        public bool usedOwnerPassword = true;
        ...
        public virtual void SetStandardHandlerDicEntries(PdfDictionary encryptionDictionary, byte[] userKey
            , byte[] ownerKey) {
        ...
        public virtual byte[] GenerateOwnerPasswordIfNullOrEmpty(byte[] ownerPassword) {
        ...
        public virtual byte[] GetIsoBytes(PdfString @string) {
            return ByteUtils.GetIsoBytes(@string.GetValue());
        }

        public static bool EqualsArray(byte[] ar1, byte[] ar2, int size) {
